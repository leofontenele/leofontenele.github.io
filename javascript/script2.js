...
function Click3() { 
 document.getElementById("frase1").innerHTML = "<br>Atualmente, venho de um término de estágio como Software Engineer <b>(JavaScript, SQL e Outsystems)</b> pela <b>Lusodata - PDMFC</b> e, simultaneamente, <br>realizo alguns trabalhos como freelancer em plataformas comerciais <b>(Wordpress, Shopify, etc)</b> ou trabalhando em projetos específicos.";
}
function Unclick() { 
